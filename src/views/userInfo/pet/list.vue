...
<div class="app-container">
    ...
    <el-form :inline="true" class="demo-form-inline">
      ...
      <el-form-item>
        ...
        <el-form-item>
        <el-select filterable v-model="PetQuery.condition" clearable placeholder="所属成员">
      ...
      <el-input placeholder="请输入内容"  v-model="select" class="input-with-select">
        ...
        <el-option label="车辆牌照" value="PetQuery.licensePlate"></el-option>
     ...
     <el-button type="warning" :disabled = "isDelBatchMerchantBtn" plain @click="batchDelete()" >批量删除</el-button>
      ...
      <router-link :to="'/userInfo/pet/add/'">
            <el-button type="primary"  >新增宠物</el-button>
      </router-link>
    ...
    <el-table
      ...
      <el-table-column prop="adoptTime" label="收养日期"  />
      <el-table-column prop="createTime" label="创建日期"  />

      <el-table-column label="操作" width="200" align="center">
        <template slot-scope="scope">

        <el-button type="primary" size="mini" icon="el-icon-edit" @click="openUpdatePetBtn(scope.row.id)" >修改</el-button>
    ...
    <el-dialog
      ...
      >
      <span>
        <el-form :model="Pet" :rules="rules" ref="Pet" label-width="100px" class="demo-Pet">

        <el-form-item label="所属成员" prop="userId">
          <el-select v-model="Pet.userId" filterable placeholder="请选择所属成员">
            <el-option label="zhangsan" value="36"></el-option>
            <el-option label="lisi" value="38"></el-option>
          </el-select>
        </el-form-item>
         <el-form-item label="宠物名称" prop="name">
          <el-input v-model="Pet.name" placeholder="请输入宠物名称"></el-input>
        </el-form-item>

        <el-form-item label="宠物颜色" prop="color">
          <el-input v-model="Pet.color" placeholder="请输入宠物颜色"></el-input>
        </el-form-item>
         ...
         <el-form-item label="收养日期" required>
          ...
          <el-form-item label="成员照片" required>
            ...
            <el-popover placement="top-start" title="" trigger="hover"
             content="点击添加图片">
               <img style="width: 100px; height: 100px" :src="Pet.photo" alt="" slot="reference" @click="imagecropperShow=true" >
            </el-popover>
        </el-form-item>

        <el-form-item label="备注" prop="remark">
          <el-input type="textarea" v-model="Pet.remark"></el-input>
        </el-form-item>
      </el-form>
      </span>
      <span slot="footer" class="dialog-footer">
      <el-button @click="updateBtn = false">取 消</el-button>
      <el-button type="primary" @click="update('Pet')">确 定</el-button>
      </span>
    </el-dialog>
...
export default {
    ...
    methods:{
      getList(current=1){
          ...
          pet.getPetList(this.current,this.size,this.PetQuery)
          .then(response =>{
              this.list = response.data.petInfoList
